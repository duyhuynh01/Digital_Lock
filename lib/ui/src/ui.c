...
void ui_event_FPOptionbtn(lv_event_t *e)
{
    ...
    if (event_code == LV_EVENT_PRESSED)
    {
        _ui_screen_change(&ui_SceenFinger, LV_SCR_LOAD_ANIM_MOVE_RIGHT, 100, 0, &ui_SceenFinger_screen_init);
        _ui_screen_delete(&ui_ScreenSetting);
    }
}
void ui_event_CardOptionbtn(lv_event_t *e)
{
    ...
    if (event_code == LV_EVENT_PRESSED)
    {
        _ui_screen_change(&ui_SceenCard, LV_SCR_LOAD_ANIM_MOVE_RIGHT, 100, 0, &ui_SceenCard_screen_init);
        _ui_screen_delete(&ui_ScreenSetting);
    }
}
void ui_event_PressDeleteFinger(lv_event_t *e)
{
    ...
    if (event_code == LV_EVENT_PRESSED)
    {
        _ui_screen_change(&ui_screenFingerDelete, LV_SCR_LOAD_ANIM_FADE_ON, 100, 0, &ui_screenFingerDelete_screen_init);
...
void ui_event_PressShowFinger(lv_event_t *e)
{
    ...
    if (event_code == LV_EVENT_PRESSED)
    {
        _ui_screen_change(&ui_screenFingerShow, LV_SCR_LOAD_ANIM_FADE_ON, 100, 0, &ui_screenFingerShow_screen_init);
        _ui_screen_delete(&ui_SceenFinger);
        callFuncShowFP(e);
    }
}
...
void ui_event_PressDeleteCard(lv_event_t *e)
{
    ...
    if (event_code == LV_EVENT_PRESSED)
    {
        _ui_screen_change(&ui_screenCardDelete, LV_SCR_LOAD_ANIM_FADE_ON, 100, 0, &ui_screenFingerDelete_screen_init);
...
void ui_event_PressShowCard(lv_event_t *e)
{
    ...
    if (event_code == LV_EVENT_PRESSED)
    {
        _ui_screen_change(&ui_screenCardShow, LV_SCR_LOAD_ANIM_FADE_ON, 100, 0, &ui_screenCardShow_screen_init);
        _ui_screen_delete(&ui_SceenCard);
        callFuncShowCard(e);
    }
}
