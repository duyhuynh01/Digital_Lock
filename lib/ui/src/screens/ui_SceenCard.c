...
lv_obj_set_width( ui_PressDeleteCard, 65);
lv_obj_set_height( ui_PressDeleteCard, 65);
lv_obj_set_x( ui_PressDeleteCard, 55 );
lv_obj_set_y( ui_PressDeleteCard, 40 );
...
lv_obj_set_width( ui_PressAddCard, 65);
lv_obj_set_height( ui_PressAddCard, 65);
lv_obj_set_x( ui_PressAddCard, -57 );
lv_obj_set_y( ui_PressAddCard, 40 );
...
lv_obj_set_width( ui_PressRestoreCard, 65);
lv_obj_set_height( ui_PressRestoreCard, 65);
lv_obj_set_x( ui_PressRestoreCard, -57 );
lv_obj_set_y( ui_PressRestoreCard, 170 );
...
lv_obj_set_width( ui_PressShowCard, 65);
lv_obj_set_height( ui_PressShowCard, 65);
lv_obj_set_x( ui_PressShowCard, 55 );
lv_obj_set_y( ui_PressShowCard, 170 );
...
lv_obj_set_style_text_font(ui_BackFinger4, &lv_font_montserrat_18, LV_PART_MAIN| LV_STATE_DEFAULT);

ui_areaPopupCard = lv_textarea_create(ui_SceenCard);
lv_obj_set_height( ui_areaPopupCard, 80);
lv_obj_set_width( ui_areaPopupCard, lv_pct(90));
...
lv_obj_set_style_text_font(ui_areaPopupCard, &lv_font_montserrat_14, LV_PART_MAIN| LV_STATE_DEFAULT);
