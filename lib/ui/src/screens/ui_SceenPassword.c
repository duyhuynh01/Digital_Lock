...
lv_textarea_set_placeholder_text(ui_areaPWCurrent,"Current password");
...
lv_textarea_set_placeholder_text(ui_areaPWNew,"New password");
...
lv_textarea_set_placeholder_text(ui_areaPWConfirm,"Confirm password");
