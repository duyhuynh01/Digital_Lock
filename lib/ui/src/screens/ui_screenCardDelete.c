...
lv_obj_set_width( ui_Label34, 200);
lv_obj_set_height( ui_Label34, 40);
...
lv_obj_set_width( ui_areaEnterNameDeleteCard, lv_pct(80));
...
lv_obj_set_height( ui_btnBackCardDelete, 26);
...
lv_obj_set_style_text_font(ui_BackFinger6, &lv_font_montserrat_18, LV_PART_MAIN| LV_STATE_DEFAULT);

ui_btnHomeCardDelete = lv_btn_create(ui_screenCardDelete);
lv_obj_set_width( ui_btnHomeCardDelete, 53);
lv_obj_set_height( ui_btnHomeCardDelete, 26);
...
lv_obj_set_style_text_font(ui_BackHomeAddFinger4, &lv_font_montserrat_18, LV_PART_MAIN| LV_STATE_DEFAULT);

ui_areaNotyfyDeleteCard = lv_textarea_create(ui_screenCardDelete);
lv_obj_set_height( ui_areaNotyfyDeleteCard, 80);
lv_obj_set_width( ui_areaNotyfyDeleteCard, lv_pct(90));
...
lv_obj_set_style_text_font(ui_areaNotyfyDeleteCard, &lv_font_montserrat_14, LV_PART_MAIN| LV_STATE_DEFAULT);
