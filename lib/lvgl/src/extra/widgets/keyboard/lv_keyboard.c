...
static const char * const default_kb_map_lc[] = {"1", "2", "3", "4", "5", "6", "7", "8", "9", "0", "\n",
                                                 "q", "w", "e", "r", "t", "y", "u", "i", "o", "p", "\n",
                                                 " ", "a", "s", "d", "f", "g", "h", "j", "k", "l", " ","\n",
                                                 "1#", "z", "x", "c", "v", "b", "n", "m", LV_SYMBOL_BACKSPACE, "\n",
                                                 "ABC", " ", LV_SYMBOL_OK, ""
                                                };
...
static const lv_btnmatrix_ctrl_t default_kb_ctrl_lc_map[] = {
    ...
    LV_KEYBOARD_CTRL_BTN_FLAGS | 1, LV_KB_BTN(3), LV_KB_BTN(3), LV_KB_BTN(3), LV_KB_BTN(3), LV_KB_BTN(3), LV_KB_BTN(3), LV_KB_BTN(3), LV_KB_BTN(3), LV_KB_BTN(3), LV_KEYBOARD_CTRL_BTN_FLAGS | 1,
    LV_KEYBOARD_CTRL_BTN_FLAGS | 4, LV_KB_BTN(3), LV_KB_BTN(3), LV_KB_BTN(3), LV_KB_BTN(3), LV_KB_BTN(3), LV_KB_BTN(3), LV_KB_BTN(3), LV_KEYBOARD_CTRL_BTN_FLAGS | 4,
    LV_KEYBOARD_CTRL_BTN_FLAGS | 3, 6,  LV_KEYBOARD_CTRL_BTN_FLAGS | 3
};
...
static const lv_btnmatrix_ctrl_t default_kb_ctrl_spec_map[] = {
    ...
    LV_KB_BTN(3), LV_KB_BTN(3), LV_KB_BTN(3), LV_KB_BTN(3), LV_KB_BTN(3), LV_KB_BTN(3), LV_KB_BTN(3), LV_KB_BTN(3), LV_KB_BTN(3), LV_KB_BTN(3),
    LV_KB_BTN(1), LV_KB_BTN(1), LV_KB_BTN(1), LV_KB_BTN(1), LV_KB_BTN(1), LV_KB_BTN(1), LV_KB_BTN(1), LV_KB_BTN(1), LV_KEYBOARD_CTRL_BTN_FLAGS | 2,
